...
def get_list_shops(request):
    ...
    return render(request, 'list_shops.html', {'shops': context})
...
def get_list_storages(request):
    ...
    return render(request, 'list_storages.html', {'storages': context})
...
def get_list_products(request):
    ...
    return render(request, 'list_available_products.html', {'available_products': context})
...
def get_list_sold_products(request):
    ...
    return render(request, 'list_sold_products.html', {'sold_products': context})
...
def product_list_by_storage(request, id):
    ...
    return render(request, 'products_of_storage.html', {'products_of_storage': context, 'storage': storage})
...
def product_list_by_shop(request, id):
    ...
    context = pg_records(request, products, 3)
    return render(request, 'products_of_shop.html', {'products_of_shop': context, 'shop': shop})
